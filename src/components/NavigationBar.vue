        ...
        >
          <li>
            ...
            <a
              v-show="store.page === 'dashboard'"
              @click="store.logout()"
              class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent cursor-pointer"
              aria-current="page"
              >Logout</a
            >
          </li>
